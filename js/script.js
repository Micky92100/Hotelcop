$(document).ready(function () {
    ...
    $(function () {
        ...
        $('#reservation').submit(function () {
            const personne = ($('#personne').val());
            const chambre = ($('#chambre').val());
            const restauration = ($('#restauration').val());
            const spa = ($('#spa').val());
        })
    });
            */
            ...
            submitHandler: function (form) {
                ...
                alert(`Merci, vous réservation est enregistrée. Vous pouvez finaliser votre commande en cliquant sur panier.`+
                `\n ${personne} * ${chambre} * ${restauration} * ${spa} = ${personne * chambre * restauration * spa}`);
                return false;
            }
        });
